...
func _create_loose_survival_pickups() -> void:
	...
	var pickups := [
		...
		{"id": "loose_canned_food_0", "name": "Lata de guiso", "type": "food", "weight": 0.5, "qty": 1, "use": 35.0, "paths": [CANNED_FOOD_LOW_MODEL], "scale": 0.3, "rot": Vector3(0, 30, 0), "color": Color(0.38, 0.28, 0.15)},
		{"id": "loose_canned_food_1", "name": "Lata de atun", "type": "food", "weight": 0.3, "qty": 1, "use": 18.0, "paths": [FOOD_CAN_415G_MODEL], "scale": 0.3, "rot": Vector3(0, -45, 0), "color": Color(0.42, 0.30, 0.12)},
		{"id": "loose_canned_food_2", "name": "Lata de guiso", "type": "food", "weight": 0.5, "qty": 1, "use": 35.0, "paths": [CANNED_FOOD_LOW_MODEL], "scale": 0.3, "rot": Vector3(0, 80, 0), "color": Color(0.35, 0.25, 0.10)},
		{"id": "loose_canned_food_3", "name": "Lata de atun", "type": "food", "weight": 0.3, "qty": 1, "use": 18.0, "paths": [FOOD_CAN_415G_MODEL], "scale": 0.3, "rot": Vector3(0, 120, 0), "color": Color(0.40, 0.28, 0.14)},
	]
...
func _create_house_loot() -> void:
	...
	var house_loot_pool := [
		...
		{"name": "Lata de guiso", "type": "food", "weight": 0.5, "qty": 1, "use": 35.0, "paths": [CANNED_FOOD_LOW_MODEL], "scale": 0.3, "rot": Vector3(0, 30, 0), "color": Color(0.38, 0.28, 0.15)},
		{"name": "Lata de atun", "type": "food", "weight": 0.3, "qty": 1, "use": 18.0, "paths": [FOOD_CAN_415G_MODEL], "scale": 0.3, "rot": Vector3(0, -45, 0), "color": Color(0.42, 0.30, 0.12)},
